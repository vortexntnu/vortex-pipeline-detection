...
class LinedetectorPipe {
   ...
   public:
    ...
    int detectSingleLine(const mat& points,
                         const mat& values,
   ...
   public:
    ...
    LinedetectorPipe(int n = 5,
        ...
        : n(n),
          k(k),
          t(t),
          fracOfPoints(fracOfPoints),
          removeT(removeT),
          finalScorethresh(finalScorethresh),
        ...
        t: Threshold for points to be considered inliers, for the purpose of
        scoring fracOfPoints: minimum fraction of points that need to bee
        inliers for a line to be considered removeT: Threshold for points to be
        removed between iterations finalScorethresh: required score to be
        counted as a detected line minTurnAngle: minimum angle difference
        between lines, radians (ofc) size: what size of square the image will be
        resized to during preprocessing
        */
